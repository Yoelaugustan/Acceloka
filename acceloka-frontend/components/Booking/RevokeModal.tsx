    ...
    if (bookedTicketId !== null) {
      ...
      fetch(`http://localhost:5224/api/v1/get-booked-ticket/${bookedTicketId}`)
        ...
        .then((data: BookedTicketCategoryDetail[]) => {
          setDetails(data);
          // Initialize revoke quantities to 1 for new items
          ...
          {loading ? (
            ...
            details.map((category) => (
              <div key={category.categoryName}>
                <h3 className="text-lg font-bold text-dark-1 uppercase mb-3 py-1.5 border-b border-dark-4/10">
                ...
                <ul className="space-y-4">
                  {category.tickets.map((ticket) => (
                    <li
                      ...
                      className="relative flex items-stretch rounded-xl border-2 border-yellow-500 bg-[#f5c842] shadow-sm font-mono overflow-visible"
                    >
                      ...
                      <div className="flex-1 p-4 px-6 flex flex-col gap-1">
                        ...
                        <p className="font-bold text-dark-1 mt-1 text-sm">
                          Quantity:
                      ...
                      <div className="w-32 flex flex-col items-center justify-center pr-4 gap-2">
                        ...
                        <button
                          ...
                          className="w-full flex justify-center items-center gap-1 bg-error text-white py-1.5 rounded-lg hover:bg-error/80 transition-all cursor-pointer active:scale-95 disabled:opacity-50"
                        >
