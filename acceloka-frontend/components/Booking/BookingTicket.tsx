  ...
  return (
    <div className="relative group w-full">
      ...
      <div className="relative flex items-stretch w-full rounded-xl border-2 border-yellow-500 bg-[#f5c842] shadow-md min-h-35 font-mono">
        ...
        <div className="w-24 flex flex-col items-center justify-center p-4 gap-2">
          <button
          ...
          <button
            ...
            className="w-full py-2 bg-error text-white text-[10px] font-bold rounded-lg hover:bg-error/80 transition-all cursor-pointer active:scale-95"
          >
            Revoke Ticket
          </button>
        </div>
